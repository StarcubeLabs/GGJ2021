Shader "GGJ2021/MinionsArt/Lit Glass Normal" {
    Properties{
        [Header(Main)]
...
#pragma lighting ToonRamp exclude_path:prepass
    ...
    void surf(Input IN, inout SurfaceOutput o) {
        ...
        // view specular
        half3 calcnormal = UnpackNormal(tex2D(_BumpMap, IN.viewDir));
        half viewSpec =  saturate(dot(calcnormal, (IN.viewDir))); // basing on normal and light direction
